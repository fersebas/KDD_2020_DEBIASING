%INCLUDE "&path.\code\model_dani\4_RadiusAlgorithm_Test.sas";
...
/* to generate TEST_FINAL_OUT.txt */

%incorporaRecomendacionesPython(
ficheroEntradaPython=TEST_FINAL_OUT,
numeroRecomendaciones=500);

data kdd2020.TEST_7MODELOS_DISTANCIAS_ALL95;
  set work.resultadoPython;
  item_id=target;
...
/* PYTHON code DistanciesAlgorithm must be previouly invoqued */
/* to generate TEST_FINAL_TXT_OUT.txt */

%incorporaRecomendacionesPython(
ficheroEntradaPython=TEST_FINAL_TXT_OUT,
numeroRecomendaciones=500);

data kdd2020.TEST_7MODELOS_DISTANCIAS_TXT95;
  set work.resultadoPython;
  item_id=target;
