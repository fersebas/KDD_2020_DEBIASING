%global tablaTrain;
%let tablaTrain=kdd2020.Underexpose_all_click_&parametroHistorial;
%global tablaTest;
%let tablaTest=kdd2020.Underexpose_test_click_&parametroHistorial;
%global tablaAll;
%let tablaAll=kdd2020.Underexpose_all_click_&parametroHistorial;
...
ficheroSalidaPython=);
  ...
  %do contadorRadioMacro=1 %to &radio;
    ...
    proc sort data=kdd2020.Underexpose_test_qtime_&historial
  ...
  %do contadorPhases=0 %to &phase;
    ...
    proc sql;
      ...
      from kdd2020.Underexpose_all_click_&contadorPhases;
    quit;
    ...
    proc sql;
      ...
      select * from work.anterior_y_posterior
      where user_id in
      (select distinct user_id from kdd2020.Underexpose_test_qtime_&contadorPhases);
    quit;
  ...
  data _null_;
    ...
    file "&path.\user_data\tmp_model_dani\Underexpose_item_feat_prin_all_test_&variables..txt" dlm=",";
    put item_id
    %do contadorComponentes=1 %to &numeroComponentes;
      &&prin&contadorComponentes
    %end;
...
ficheroSalidaPython=TEST_FINAL);

data kdd2020.TEST_7MODELOS_ALGDANI_All95;
  set work.anterior_y_posterior;
  item_id=target;
...
usaSessionId=1,
numeroRecomendaciones=500,
ficheroSalidaPython=TEST_FINAL_TXT);
run;

data kdd2020.TEST_7MODELOS_BESTDANI_All95;
  set work.anterior_y_posterior;
  item_id=target;
...
/**/
/*/* Invoque PYTHON code: DistanciesAlgorithm with TEST_FINAL_ALL.txt */*/
/**/
/*/* Invoque PYTHON code: DistanciesAlgorithm with TEST_FINAL_TXT.txt */*/
/**/